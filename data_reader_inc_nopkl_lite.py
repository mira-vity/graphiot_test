    ...
    def __init__(self,
        ...
        if self.mask == 'positive':
            ...
            for idx in range(len(data['adj_list'])):
                ...
                data['adj_list_positive'].append(adj_matrix)#转到positive中
        ...
        train_ids_before1 = self.random_select_examplers(train_ids0[0], 0, n_classes-9, labels, 1000//12, 'before_numbers')
        ...
        train_ids_before2 = self.random_select_examplers(train_ids_all1[0], 0, n_classes-6, labels, 1000//15, 'before_numbers')
        ...
        train_ids_before3 = self.random_select_examplers(train_ids_all2[0], 0, n_classes-3, labels, 1000//18, 'before_numbers')#有没有可能是回访数量减少直接导致？
