...
from graph_data_inc_gat import GraphData
from data_reader_inc_gat import DataReader, shared_params
...
date = 'csv_sum_22cls'#此处为document中的日期文件夹名称 #csv_sum_2cls_800_22cls_rearranged
...
parser.add_argument('--epochs', type=int, default=100, help='Number of epochs to train.')#初始为5
