...
class GraphData(torch.utils.data.Dataset):
    ...
    def set_fold(self, data, fold_id, name):
        ...
        self.features_min = data['features_min']
        if name == 'split':
    ...
    def pad(self, mtx, desired_dim1, desired_dim2=None, value=0):
        ...
        if desired_dim2 is not None:#节点pad
            mtx = np.pad(mtx, ((0, desired_dim1 - sz[0]), (0, desired_dim2 - sz[1])), 'constant', constant_values=value)#dim1修改为2*30
        else:#特征维度pad
